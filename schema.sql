...
create table
  public.inventory (
    ...
    constraint inventory_citizen_id_fkey foreign key (citizen_id) references citizens (id)
  ) tablespace pg_default;
...
create table
  public.transaction_items (
    ...
    constraint transaction_items_listing_id_fkey foreign key (listing_id) references market (id),
